...
- **Woody grove LOD:** authored HIGH / MEDIUM / LOW and canopy policy stay on the grove via [`WoodyGroveLod`](./chico/groves/src/grove/woody_lod.rs). Opening Orchard should still show `2 / 5 / 12` and `ordinary`.
