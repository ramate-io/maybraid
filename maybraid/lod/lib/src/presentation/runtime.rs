...
use crate::scene::{
	arm_keep_if_empty, LodCullRegionCursor, LodCullRegions, LodCullRegionsStatus,
	LodRefreshRegions, LodRefreshRegionsStatus,
};
...
/// newly entered [`LodPresentRegion<M>`] strips.
