...
pub use projectiles::{
	BoltSpec, BulletSpec, FireOnTrigger, FirearmWeaponsPlugin, Flight, LaserBeam, LaserSpec,
	PenetrationCost, ProjectileLoad, TriggerFire, Weapon, WeaponsArmed, BARREL_REST_LENGTH,
};
