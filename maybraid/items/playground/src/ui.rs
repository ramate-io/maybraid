...
pub fn ui_config() -> GameCommandUiConfig {
	GameCommandUiConfig {
		...
		empty_console_text: "Console: `show bullpup`, `help` — wheel or PgUp/PgDn".into(),
		root_background: Color::srgba(0.12, 0.14, 0.18, 0.82),
		controls_hint: "help — show <concept> — Enter — history — PgUp/PgDn".into(),
	}
}
...
pub(crate) fn sync_command_status_text(
	...
	status.0 = format!("firearm {}", config.concept.label());
}
