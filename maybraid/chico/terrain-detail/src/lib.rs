...
//!
//! Same shape as forests and groves: authored GLB **components** (`SceneRef` +
//! `MaterialRef`), 40 m **outcropping** recipes, 400 m **formation** throws, and a
//! select-only [`TerrainDetail`] parent.
...
pub use component::{rock_material_ref, RockComponent, CHICO_ROCK_MATERIAL};
pub use extent::{
...
pub use present::{spawn_rock, FlatTerrainDetailPresenter, TerrainDetailPresenterState};
