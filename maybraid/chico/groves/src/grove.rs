...
pub use vc_compose::{
	...
	woody_grove_scene_chunks, woody_grove_scene_chunks_keep_low_plants, woody_playable_stick_nodes,
	CanopyProxySite, GrovePlantStickSource, TrainedCanopyProxy, DEFAULT_PLANT_MEDIUM_FACTOR,
