...
#[cfg(feature = "render")]
pub use vc::{
	GoettingenFollow, GoettingenFollowParams, GoettingenFollowPlant, GOETTINGEN_FOLLOW_STRUCTURAL_HIGH_FACTOR,
	GOETTINGEN_FOLLOW_STRUCTURAL_LOW_FACTOR, GOETTINGEN_FOLLOW_STRUCTURAL_MEDIUM_FACTOR,
};
