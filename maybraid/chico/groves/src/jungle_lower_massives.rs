...
mod vc {
	...
	use chico_sbs_trees::{BraidOakTree, BraidOakTreeParams, HonuBanyan, HonuBanyanParams, JungleStorybookTree, JungleStorybookTreeParams, SopesBanyan, SopesBanyanParams, WaialeaPalm, WaialeaPalmParams};
	...
	pub struct JungleLowerMassives {
		pub plants: Vec<JungleLowerMassivesPlant>,
		...
		fn nest_plant_chunks(&self, lod_ref: &LodRef) -> Vec<SceneChunk> {
			self.plants
				...
				.map(|plant| match &plant.kind {
					JungleLowerMassivesKind::Honu(t) => nest_placed_plant_chunk(
						t.clone(),
						plant.placement,
					...
					JungleLowerMassivesKind::Sope(t) => nest_placed_plant_chunk(
						t.clone(),
						plant.placement,
						&plant.stick_material,
						&plant.ball_material,
					...
					JungleLowerMassivesKind::JungleStorybook(t) => nest_placed_plant_chunk(
						t.clone(),
						plant.placement,
						&plant.stick_material,
						&plant.ball_material,
					...
					JungleLowerMassivesKind::Waialea(t) => nest_placed_plant_chunk(
						t.clone(),
						plant.placement,
						&plant.stick_material,
						&plant.ball_material,
					...
					JungleLowerMassivesKind::Oak(t) => nest_placed_plant_chunk(
						t.clone(),
						plant.placement,
						&plant.stick_material,
						&plant.ball_material,
	...
	fn grow_plant(
		...
		let kind = match placed.variant.item() {
			JungleLowerMassivesItem::Honu(banyan) => {
				...
				JungleLowerMassivesKind::Honu(params.build())
			}
			JungleLowerMassivesItem::Sope(banyan) => {
				...
				params.geometry = samples.geometry;
				JungleLowerMassivesKind::Sope(params.build())
			}
			JungleLowerMassivesItem::JungleStorybook(jungle) => {
				...
				params.geometry = samples.geometry;
				params.growth_spawn_fraction = samples.growth_spawn_fraction;
				JungleLowerMassivesKind::JungleStorybook(params.build())
			}
			JungleLowerMassivesItem::WaialeaPalm(palm) => {
				...
				JungleLowerMassivesKind::Waialea(params.build())
			}
			JungleLowerMassivesItem::BraidOak(oak) => {
				...
				JungleLowerMassivesKind::Oak(params.build())
			}
		};
...
#[cfg(feature = "render")]
pub use vc::{
	JungleLowerMassives, JungleLowerMassivesParams, JungleLowerMassivesPlant, JUNGLE_LOWER_MASSIVES_STRUCTURAL_HIGH_FACTOR,
	JUNGLE_LOWER_MASSIVES_STRUCTURAL_LOW_FACTOR, JUNGLE_LOWER_MASSIVES_STRUCTURAL_MEDIUM_FACTOR,
};
