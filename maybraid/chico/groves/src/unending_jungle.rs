...
mod vc {
	...
	use chico_sbs_trees::{HonuBanyan, HonuBanyanParams, JungleStorybookTree, JungleStorybookTreeParams, PenmarchTorch, PenmarchTorchParams, RorysHeadTrained, RorysHeadTrainedParams, SopesBanyan, SopesBanyanParams, StorybookTree, StorybookTreeParams, WaialeaPalm, WaialeaPalmParams};
	...
	impl UnendingJungleParams {
		...
		pub fn build(&self) -> UnendingJungle {
			UnendingJungle::from_placements(&self.placements(), self.grove.noise, &self.extent)
		}
	}
...
#[cfg(feature = "render")]
pub use vc::{
	UnendingJungle, UnendingJungleParams, UnendingJunglePlant, UNENDING_JUNGLE_STRUCTURAL_HIGH_FACTOR,
	UNENDING_JUNGLE_STRUCTURAL_LOW_FACTOR, UNENDING_JUNGLE_STRUCTURAL_MEDIUM_FACTOR,
};
