...
mod vc {
	...
	use chico_sbs_trees::{
		BraidOakTree, BraidOakTreeParams, HighBushShoots, HighBushShootsParams, StorybookTree,
		StorybookTreeParams,
	};
	...
	impl Default for RiparianGeneralParams {
		fn default() -> Self {
			Self {
				...
				terrain: FlatTerrainSample { elevation: 0.20, steepness: 0.10 },
	...
	pub struct RiparianGeneral {
		pub plants: Vec<RiparianGeneralPlant>,
		...
		fn nest_plant_chunks(&self, lod_ref: &LodRef) -> Vec<SceneChunk> {
			self.plants
				...
				.map(|plant| match &plant.kind {
					RiparianGeneralKind::Oak(t) => nest_placed_plant_chunk(
						t.clone(),
						plant.placement,
					...
					RiparianGeneralKind::Storybook(t) => nest_placed_plant_chunk(
						t.clone(),
						plant.placement,
						&plant.stick_material,
						&plant.ball_material,
					...
					RiparianGeneralKind::Bush(t) => nest_placed_plant_chunk(
						t.clone(),
						plant.placement,
						&plant.stick_material,
						&plant.ball_material,
	...
	impl LodScene for RiparianGeneral {
...
#[cfg(feature = "render")]
pub use vc::{
	RiparianGeneral, RiparianGeneralParams, RiparianGeneralPlant,
	RIPARIAN_GENERAL_STRUCTURAL_HIGH_FACTOR, RIPARIAN_GENERAL_STRUCTURAL_LOW_FACTOR,
	RIPARIAN_GENERAL_STRUCTURAL_MEDIUM_FACTOR,
};
