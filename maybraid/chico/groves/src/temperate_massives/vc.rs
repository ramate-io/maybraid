...
use super::{
	definition, TemperateMassivesCell, TemperateMassivesItem, MASSIVE_STORYBOOK, RARE_MASSIVE_RORY,
};
...
remixed_sbs_plant!(RareMassiveRory, RorysHeadTrained, RorysHeadTrainedParams, RARE_MASSIVE_RORY);
...
crate::impl_grove_plant_sticks!(TemperateMassivesPlant, TemperateMassivesKind, Oak, Storybook, Rory);
