...
#[cfg(feature = "render")]
pub const CHRISTMAS_TAIGA_STRUCTURAL_HIGH_FACTOR: f32 = 8.0;
#[cfg(feature = "render")]
pub const CHRISTMAS_TAIGA_STRUCTURAL_MEDIUM_FACTOR: f32 = 14.0;
#[cfg(feature = "render")]
...
#[cfg(feature = "render")]
pub use vc::{ChristmasTaiga, ChristmasTaigaParams, ChristmasTaigaPlant};
