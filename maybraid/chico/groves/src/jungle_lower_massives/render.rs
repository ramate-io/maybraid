	...
	Terrain: TerrainSample + Clone + Send + Sync + 'static + Default + clap::Args,
{
	...
	#[arg(skip)]
	resolved_placements: Option<Vec<GrovePlacedCell<JungleLowerMassivesCell>>>,
	...
	Terrain: TerrainSample + Clone + Send + Sync + 'static + Default + clap::Args,
{
	pub fn with_resolved_placements(
		resolved_placements: Vec<GrovePlacedCell<JungleLowerMassivesCell>>,
		terrain: Terrain,
	...
	pub fn placements(&self) -> Vec<GrovePlacedCell<JungleLowerMassivesCell>> {
