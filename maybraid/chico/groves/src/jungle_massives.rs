...
mod vc {
	...
	use chico_sbs_trees::{HonuBanyan, HonuBanyanParams, JungleStorybookTree, JungleStorybookTreeParams, SopesBanyan, SopesBanyanParams};
	...
	impl JungleMassivesParams {
		...
		pub fn build(&self) -> JungleMassives {
			JungleMassives::from_placements(&self.placements(), self.grove.noise, &self.extent)
		}
	}
...
#[cfg(feature = "render")]
pub use vc::{
	JungleMassives, JungleMassivesParams, JungleMassivesPlant, JUNGLE_MASSIVES_STRUCTURAL_HIGH_FACTOR,
	JUNGLE_MASSIVES_STRUCTURAL_LOW_FACTOR, JUNGLE_MASSIVES_STRUCTURAL_MEDIUM_FACTOR,
};
