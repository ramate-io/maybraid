...
use chico_groves::palm_shade::{definition, PalmShadeCell, PalmShadeItem};
use chico_groves::{
	...
	Terrain: GroveWorldSample + Clone + Send + Sync + 'static + Default + clap::Args,
{
	pub fn with_resolved_placements(
		resolved_placements: Vec<GroveCellVariant<PalmShadeCell>>,
		terrain: Terrain,
...
mod tests {
	...
	fn with_resolved_placements_skips_live_selection() -> Result<()> {
		let placement =
			GroveCellVariant::new(PalmShadeCell::ShadeDatePalm, Vec3::new(1.0, 0.0, 2.0), 1.0);
