//! [`RenderItem`] implementations for Chico cellular groves.
//!
//! Grove selection, authored geometry, and [`BuildWithNoise`] variant impls live in
//! [`chico_groves`]; this crate holds the CLI-driven preview/spawn layer for each
//! well-known grove.
