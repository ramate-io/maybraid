...
use chico_groves::forlorn_savanna::{definition, ForlornSavannaCell, ForlornSavannaItem};
use chico_groves::{
	...
	Terrain: GroveWorldSample + Clone + Send + Sync + 'static + Default + clap::Args,
{
	pub fn with_resolved_placements(
		resolved_placements: Vec<GroveCellVariant<ForlornSavannaCell>>,
		terrain: Terrain,
...
mod tests {
	...
	fn with_resolved_placements_skips_live_selection() -> Result<()> {
		let placement =
			GroveCellVariant::new(ForlornSavannaCell::SavannaRory, Vec3::new(1.0, 0.0, 2.0), 1.0);
