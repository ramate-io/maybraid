...
use chico_sbs_geometry::{BallStickSegment, DatePalmChain};
use chico_stick_components::chico_stick::ChicoStick;
use procedural_common::NoiseParams;

#[derive(Clone)]
pub(crate) struct DatePalmStickRule<StickM, StickS>
where
	StickM: Material,
...
impl<StickM, StickS> StickRenderRule<ChicoStick<StickM, StickS>, DatePalmChain>
	for DatePalmStickRule<StickM, StickS>
where
	...
	StickS: Clone + Into<MeshMaterial3d<StickM>> + Send + Sync + 'static + Default,
{
	fn stick_render_item_for(
		...
		_parent_hysteresis: &DatePalmChain,
		_child_hysteresis: &DatePalmChain,
