...
use chico_sbs_geometry::{BallStickSegment, FriendsConiferChain};
use chico_stick_components::chico_stick::ChicoStick;
use procedural_common::NoiseParams;

#[derive(Clone)]
pub(crate) struct TemperateConiferStickRule<StickM, StickS>
where
	StickM: Material,
...
impl<StickM, StickS> StickRenderRule<ChicoStick<StickM, StickS>, FriendsConiferChain>
	for TemperateConiferStickRule<StickM, StickS>
where
	...
	StickS: Clone + Into<MeshMaterial3d<StickM>> + Default + Send + Sync + 'static,
{
	fn stick_render_item_for(
		...
		_parent_hysteresis: &FriendsConiferChain,
		_child_hysteresis: &FriendsConiferChain,
