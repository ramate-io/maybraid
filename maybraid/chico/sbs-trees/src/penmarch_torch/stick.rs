...
use chico_sbs_geometry::{BallStickSegment, PenmarchTorchChain, StorybookTreePhase};
use chico_stick_components::chico_stick::ChicoStick;
use procedural_common::NoiseParams;

#[derive(Clone)]
pub(crate) struct PenmarchTorchStickRule<StickM, StickS>
where
	StickM: Material,
...
impl<StickM, StickS> StickRenderRule<ChicoStick<StickM, StickS>, PenmarchTorchChain>
	for PenmarchTorchStickRule<StickM, StickS>
where
	...
	StickS: Clone + Into<MeshMaterial3d<StickM>> + Send + Sync + 'static + Default,
{
	fn stick_render_item_for(
		...
		parent_hysteresis: &PenmarchTorchChain,
		_child_hysteresis: &PenmarchTorchChain,
