...
| [`FoliageNode`](src/foliage.rs) | Canopy leaves (noisy ball, plane splay, …). |

Stick styles `Standard` / `StandardTrunk` load GLB LOD triads from `maybraid/assets/vegetation/sticks/`. SDF / inline foliage builders remain as **style variants** until foliage GLBs land.
