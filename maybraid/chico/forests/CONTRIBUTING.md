...
- Canopy bump-outs read [`BumpOutSelection`](src/bump_out.rs) on [`ForestGroveKind`](src/kind.rs) (authored density / bite / height / palette). Sample the **highest occupied layer**. Blend overlapping 100 m tiles onto the 160 m terrain cell. Do not grow groves for bump-outs.
