...
pub fn setup_debug_ui(mut commands: Commands) {
	...
	commands
		.spawn((
			...
			BackgroundColor(Color::srgba(0.1, 0.2, 0.24, 0.82)),
			DebugHudRoot,
		))
		.with_children(|parent| {
			parent.spawn((
				Text::new("SBS trees playground · / cmd · WASD · ↑↓ history · ⇧↑↓ scroll"),
