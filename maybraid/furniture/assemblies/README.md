...
[`generation`](src/generation.rs) walks Richmond [`BuildingComponents`](../../richmond/building-components/src/lib.rs) High furniture slots. [`stream`](src/stream.rs) bins those slots into 50 m [`FurnitureCell`](src/host.rs) hosts and presents a neighborhood around the camera. Do not parent kits under Richmond development hosts.
