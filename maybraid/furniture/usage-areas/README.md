...
- [`BitesCounterUsage`](src/bites_counter.rs) — ~0.85 m passage-face stations, outward display, leftover slat partitions / stock / a lounge pocket
- [`BitesKitchenUsage`](src/bites_kitchen.rs) — wall-run plus peninsula, cooktop, fridge; leftover screens and shelves (lounge only in very large rooms)
