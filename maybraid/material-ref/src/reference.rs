...
use crate::material_ref::{MaterialParameters, MaterialRef};
...
pub trait ReferenceMaterial: Material + Clone + Default {
	...
	fn with_parameters(self, _parameters: &MaterialParameters) -> Self {
		self
	}
	...
	fn from_material_ref(material_ref: &MaterialRef) -> Self {
		Self::default()
			...
			.with_parameters(&material_ref.parameters)
	}
}
