...
pub fn ui_config() -> GameCommandUiConfig {
	GameCommandUiConfig {
		...
		controls_hint:
			"L-stick move — R-stick look — hold RB / V and flick a stick to throw the skill map — L3 sprint — R3 POV — A jump — LT optic — LB irons — D-Pad / [ ] cycle map — RT use — X / E pick up — Tab drop — RT+X power — / commands"
				.into(),
	}
}
