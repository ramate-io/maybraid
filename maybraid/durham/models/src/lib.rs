...
pub use terrain::{
	...
	RollingStampCell, Terrain, TerrainBackground, TerrainBackgroundRegionPresenter, TerrainCellId,
	TerrainCellLayout, TerrainCellRing, TerrainColliderHost, TerrainColliderMeshSource,
	TerrainConfig, TerrainEntryStore, TerrainFar, TerrainFarRegionPresenter, TerrainFrictionConfig,
	TerrainGenerationInput, TerrainGenerationResult, TerrainHeightSnapshot, TerrainLodCell,
	TerrainLodIndex, TerrainLodPlugin, TerrainLodPresenter, TerrainMeshBuilder, TerrainMeshLodBand,
	TerrainNear, TerrainNearRegionPresenter, TerrainPlugin, TerrainPresentationAssets,
