...
Weapons (muzzle, cooldown, lasers) stay in item crates. Visual impacts listen to
[`ProjectileContact`](src/lib.rs); this crate does not depend on Hanabi or firearms.
