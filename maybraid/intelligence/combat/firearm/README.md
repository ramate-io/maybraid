...
- [`spotting-intelligence`](../../spotting/lib) owns semantic character discovery, bounded eye probes, respot cadence, and visibility memory. Its Avian backend broadphases `Animated` subjects instead of materializing an all-to-all candidate list, then tests capsule samples against Fixed geometry.
