...
pub fn ui_config() -> GameCommandUiConfig {
	GameCommandUiConfig {
		...
		empty_console_text: "Console: `seed 7`, `likelihood 0.4`, `terrain-radius 2`, `paths true`, `rebuild`, `stats mesh`, `help`"
			.into(),
		root_background: Color::srgba(0.08, 0.16, 0.22, 0.82),
		controls_hint: "help — seed <n> — likelihood <0-1> — terrain-radius <n> — paths <bool> — rebuild — stats mesh"
			.into(),
	}
}
