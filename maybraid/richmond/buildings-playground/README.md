...
# Divided paneling (polyline of dividing lines):
cargo run -p richmond-buildings-playground -- show divided-paneling --tile-width 1
cargo run -p richmond-buildings-playground -- show divided-paneling --three-nodes --tile-width 0.75
```
...
- `show divided-paneling [--tile-width W] [--three-nodes]` — `richmond_buildings::DividedPaneling` demo
