...
- `show trazaloid [--footprint-x/--footprint-z] [--ridge-x/--ridge-z] [--lower-height] [--upper-height] [--band-vertical-offset] [--waist-horizontal-offset] [--door-north|--door-east|--door-south|--door-west] [--door-thickness M] [--door-height-frac F] [--face-post-count N]` — two-band trapezoidal-pyramid shell (waist reveal, ground-flush lower doors, high-LOD vertical posts)
