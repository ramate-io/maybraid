...
- `show rect-ring-floor [--outer-x X] [--outer-z Z] [--inner-x X] [--inner-z Z] [--omit-south START,END]… [--floor] [--ceiling] [--door-east]… [--opening SPEC]…` — courtyard rectangular ring; omits remove outer wall runs; `side=` / AABB openings map to outer/inner solid runs
