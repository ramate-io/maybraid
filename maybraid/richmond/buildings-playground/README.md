...
- `show connecting-stairwell [--case stacked|opposite|quarter-turn|tiny|tall|stacked-pair] [--tread-fill F]` — exclusive AABB well with a circular spiral (walk-off is a landing)
