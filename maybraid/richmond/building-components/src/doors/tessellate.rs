...
impl DoorGeometry {
	pub(crate) fn kit_pieces(&self) -> Vec<Placed<DoorKit>> {
		match self {
			...
			Self::Frame15(_) => vec![
				Placed::new(
					DoorKit::FramePiece(PartitionKit::LinearHeaderSubsegment),
					Vec3::new(0.0, 0.85, 0.0),
					0.0,
				),
				Placed::new(
					DoorKit::FramePiece(PartitionKit::HeaderArc15),
				...
				Placed::new(
					DoorKit::FramePiece(PartitionKit::Arc15),
