...
pub use usage_areas::{
	...
	DINING_ROOM_SCOPE, DOOR_HEIGHT, DOOR_SIZE_SCALE, DOOR_WIDTH, EATING_AREA_SCOPE, KITCHEN_SCOPE,
	LIVING_ROOM_SCOPE, MAX_HALL_WIDTH, MIN_HALL_WIDTH, PASSAGE_CLEARANCE, RECT_LIVABLE_SCOPE,
