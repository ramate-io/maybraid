...
| [`RectangularStrip`](src/paneling/rectangular_strip.rs) / [`ClippedRectangularStrip`](src/paneling/clipped_rectangular_strip.rs) | Two-rail best-fit `PanelGeometry::Rectangle` kits (+ optional per-bay inset frames) |
