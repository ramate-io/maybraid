...
use exploratory_shaders::{EyeballShaderPlugin, SplatterShaderPlugin, WatercolorPostProcessPlugin};
...
impl Plugin for CrozonCharacterConceptsPlaygroundPlugin {
	fn build(&self, app: &mut App) {
		...
		app.add_plugins((SplatterShaderPlugin, EyeballShaderPlugin, WatercolorPostProcessPlugin))
