//! `/caole` commands for the quadruped concept species.
...
use crozon_characters::{
	species::{
		caole::{
			assets::{CaoleHeadMesh, CaoleMouthMesh},
...
pub enum Caole {
	/// Spawn a Caole quadruped through the resolved concepts pipeline.
	Preview(PreviewArgs),
}
