...
pub fn setup_camera(
	...
	let camera_pos = look_at + Vec3::new(0.0, 8.0, 12.0);
	...
	commands.spawn((
		Camera3d::default(),
		transform,
		Projection::Perspective(PerspectiveProjection { near: 0.1, far: 4_000.0, ..default() }),
		CameraController { speed: 20.0, sensitivity: 0.005, yaw, pitch },
		LodViewer,
		Msaa::Off,
		DepthPrepass,
	));
