...
pub use face_material::{
	...
	mouth_palette, FaceMaterialUniform, FaceShaderKind, FaceShaderMaterial,
	FaceShaderMaterialPlugin, EYE_PALETTE_HIGHLIGHT, EYE_PALETTE_IRIS, EYE_PALETTE_IRIS_SECONDARY,
	EYE_PALETTE_LID, EYE_PALETTE_PUPIL, EYE_PALETTE_SCLERA, EYE_SCALAR_PUPIL_SHAPE, KIND_EYE,
	KIND_MOUTH, MOUTH_PALETTE_CREASE, MOUTH_PALETTE_HIGHLIGHT, MOUTH_PALETTE_INTERIOR,
	MOUTH_PALETTE_LIP, MOUTH_PALETTE_TEETH, PUPIL_SHAPE_ROUND, PUPIL_SHAPE_SLIT, RECIPE_FACE_EYE,
	RECIPE_FACE_MOUTH,
};
