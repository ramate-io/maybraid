...
pub use face_material::{
	blink_envelope, eye_palette, lid_wrap, FaceMaterialUniform, FaceShaderKind, FaceShaderMaterial,
	FaceShaderMaterialPlugin, EYE_PALETTE_HIGHLIGHT, EYE_PALETTE_IRIS, EYE_PALETTE_LID,
	EYE_PALETTE_LIMBUS, EYE_PALETTE_PUPIL, EYE_PALETTE_SCLERA, KIND_EYE, KIND_MOUTH, RECIPE_FACE_EYE,
	RECIPE_FACE_MOUTH,
};
