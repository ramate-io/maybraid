//! Tipple asset catalog and assembly resolver.
...
/// Species-local resolver for Tipple asset choices.
pub struct TippleAssets;

impl TippleAssets {
	pub fn resolve(config: &TippleConfig) -> ResolvedCharacterAssembly {
	...
	fn beak(beak: TippleBeakMesh) -> ResolvedCharacterPart {
		ResolvedCharacterPart::new(
