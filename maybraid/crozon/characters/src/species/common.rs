...
pub use assets::{
	...
	HEAD_FULL, HEAD_GAUNT, HEAD_ORTHO_BEAR, HEAD_RIG, HEAD_STANDARD, HORNS_HARROWED_CROWN,
	HORNS_LORKEN_CROWN, MOUTH_CANINE_SNOUT, MOUTH_STANDARD, NOSE_BALLOON, NOSE_BROAD, NOSE_LOAF,
	NOSE_STANDARD,
};
