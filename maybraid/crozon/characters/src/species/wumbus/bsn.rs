...
//!
//! `data_scene()` carries the semantic [`Wumbus`] root component (including
...
use super::{
	assets::{WumbusAssets, WumbusHeadMesh, WumbusHornMesh, WumbusMouthMesh},
	pose::WumbusPose,
...
use crate::{
	...
	species::common::{
		...
		nodes as humanoid, EyeMesh, HairMesh, EAR_FLANK,
	},
};
