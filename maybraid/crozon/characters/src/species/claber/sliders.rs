//! Claber rig and feature slider values for the quadruped skeleton.
...
impl Default for ClaberSliders {
	fn default() -> Self {
		Self {
			shoulder_width: 1.0,
			hip_width: 1.0,
			...
			ear_width: 1.0,
			ear_height: 1.0,
			// Slightly short Robrek relative to the fixed socket Z scale.
			snout_length: 0.9,
		}
	}
}
