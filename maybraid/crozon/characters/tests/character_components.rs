...
use crozon_characters::{
	species::{
		...
		epiphant::{bsn::Epiphant, EpiphantConfig},
		hars::{bsn::Hars, HarsConfig},
		sonyak::{bsn::Sonyak, SonyakConfig},
		ylter::{bsn::Yilter, YilterConfig},
	},
...
fn orthograde_humanoid_species_emit_rigs_and_parts_at_every_band() {
	use crozon_characters::species::{
		brokker::{bsn::Brokker, BrokkerConfig},
		chupri::{bsn::Chupri, ChupriConfig},
		dui::{bsn::Dui, DuiConfig},
		kaller::{bsn::Kaller, KallerConfig},
		kappler::{bsn::Kappler, KapplerConfig},
		kispar::{bsn::Kispar, KisparConfig},
		lero::{bsn::Lero, LeroConfig},
		lidder::{bsn::Lidder, LidderConfig},
		mygr::{bsn::Mygr, MygrConfig},
		spibmom::{bsn::Spibmom, SpibmomConfig},
		tapp::{bsn::Tapp, TappConfig},
		tipple::{bsn::Tipple, TippleConfig},
		topple::{bsn::Topple, ToppleConfig},
		tuberwaber::{bsn::Tuberwaber, TuberwaberConfig},
