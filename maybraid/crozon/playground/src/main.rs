...
use bevy::prelude::*;
use crozon_character_playground::{
	CrozonCharacterPlaygroundPlugin, PendingStartupCommand, PlaygroundCommand,
};
...
fn main() {
	...
	if startup.is_some() {
		...
		println!("Crozon character playground — press / for commands.");
	}
	...
	App::new()
			...
			DefaultPlugins
				.set(WindowPlugin {
					primary_window: Some(Window {
						title: "Crozon Character Playground".into(),
		...
		.add_plugins(CrozonCharacterPlaygroundPlugin)
		.run();
}
