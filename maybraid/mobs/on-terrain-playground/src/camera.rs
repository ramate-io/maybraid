...
/// Near-overhead view of the authored mob on a small Durham patch. Keeping the
/// camera almost directly over the sampled center avoids putting an intervening
/// ridge between the camera and the host.
