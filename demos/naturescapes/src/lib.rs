...
use shaders::world_space_experiment::WorldSpaceExperimentMaterial;
...
impl Plugin for NatureScapesPlugin {
	fn build(&self, app: &mut App) {
		...
		app.add_plugins(bevy::pbr::MaterialPlugin::<WorldSpaceExperimentMaterial>::default());
		...
		app.add_plugins(terrain::TerrainPlaygroundPlugin {
			material: WorldSpaceExperimentMaterial::default(),
			rock_detail_material: WorldSpaceExperimentMaterial::default()
				.with_base_color(Vec4::new(0.2, 0.1, 0.1, 1.0)), // reddish brown base color
			second_rock_detail_material: WorldSpaceExperimentMaterial::default()
				.with_base_color(Vec4::new(0.5, 0.5, 0.5, 1.0)), // gray base color
			tuft_detail_material: WorldSpaceExperimentMaterial::default()
