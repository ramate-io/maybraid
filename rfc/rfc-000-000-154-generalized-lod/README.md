...
- [3: Design](#3-design)
  - [3.1: Cascade](#31-cascade)
    - [3.1.1: Rings](#311-rings)
    - [3.1.2: Outer Grid](#312-outer-grid)
    - [3.1.3: Work Set and Motion](#313-work-set-and-motion)
    - [3.1.4: Pseudocode](#314-pseudocode)
  - [3.2: `CascadeProduction`](#32-cascadeproduction)
    - [3.2.1: Core Components](#321-core-components)
    - [3.2.2: Requirement Signal](#322-requirement-signal)
    - [3.2.3: Requirement Builder](#323-requirement-builder)
    - [3.2.4: Source Trait](#324-source-trait)
    - [3.2.5: Signal Entities](#325-signal-entities)
    - [3.2.6: System](#326-system)
    - [3.2.7: Phase 1: Update `CascadePosition`](#327-phase-1-update-cascadeposition)
    - [3.2.8: Phase 2: Resolve Builder](#328-phase-2-resolve-builder)
    - [3.2.9: Phase 3: Update Chunks](#329-phase-3-update-chunks)
    - [3.2.10: Apply Requirements to New Chunks](#3210-apply-requirements-to-new-chunks)
    - [3.2.11: Apply Requirements to Existing Chunks](#3211-apply-requirements-to-existing-chunks)
    - [3.2.12: Spawn Requirement Signal](#3212-spawn-requirement-signal)
    - [3.2.13: Garbage Collect Requirement Signals](#3213-garbage-collect-requirement-signals)
    - [3.2.14: Plugin](#3214-plugin)
  - [3.3: `ChunkTracker`](#33-chunktracker)
    - [3.3.1: Tracker Trait](#331-tracker-trait)
    - [3.3.2: System](#332-system)
    - [3.3.3: Closure-Based Alternative](#333-closure-based-alternative)
    - [3.3.4: Plugin](#334-plugin)
    - [3.3.5: Design Notes](#335-design-notes)
    - [3.3.6: Integration with RFC-142: Gimme](#336-integration-with-rfc-142-gimme)
  - [3.4: `ChunkEntityTracker`](#34-chunkentitytracker)
    - [3.4.1: Core Trait](#341-core-trait)
    - [3.4.2: Parent Lookup](#342-parent-lookup)
    - [3.4.3: System](#343-system)
    - [3.4.4: Default Chunk Selection](#344-default-chunk-selection)
    - [3.4.5: Plugin](#345-plugin)
- [4: Milestones](#4-milestones)
  - [4.1: Cascade Core Extraction](#41-cascade-core-extraction)
  - [4.2: `CascadeProduction` API](#42-cascadeproduction-api)
  - [4.3: `ChunkTracker` API](#43-chunktracker-api)
  - [4.4: `ChunkEntityTracker` API](#44-chunkentitytracker-api)
  - [4.5: Integration: Terrain Loading](#45-integration-terrain-loading)
  - [4.6: Integration: Vegetation Loading](#46-integration-vegetation-loading)
  - [4.7: Integration: Urbanization Loading](#47-integration-urbanization-loading)
  - [4.8: Integration: NPC Spawning and Intelligence](#48-integration-npc-spawning-and-intelligence)
  - [4.9: End-to-End Validation](#49-end-to-end-validation)
