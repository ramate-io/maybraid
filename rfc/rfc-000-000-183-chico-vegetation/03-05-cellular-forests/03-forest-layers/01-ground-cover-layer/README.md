...
The ground cover layer selects from [Well-known Ground Cover Groves](../../../03-04-cellular-groves/03-well-known-ground-cover-groves/README.md). It is the lowest vegetation layer and is responsible for terrain-hugging materials: moss, flecks, low mats, mounds, exposed floor texture, and similar surface vegetation.
