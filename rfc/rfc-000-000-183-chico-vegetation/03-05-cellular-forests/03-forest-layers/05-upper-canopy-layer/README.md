...
The upper canopy layer selects from [Well-known Upper Canopy Groves](../../../03-04-cellular-groves/07-well-known-upper-canopy-groves/README.md). It defines the dominant tree layer of the forest cell: skyline trees, large palms, orchard crowns, savanna trees, upper conifers, and massive canopy systems.
