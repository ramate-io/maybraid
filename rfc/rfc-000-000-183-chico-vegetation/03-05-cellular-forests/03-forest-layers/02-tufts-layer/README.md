...
The tufts layer selects from [Well-known Tufts Groves](../../../03-04-cellular-groves/04-well-known-tufts-groves/README.md). It covers small upright vegetation above the ground surface: grasses, tuft clusters, reeds, low scrubby tuft forms, and other repeated vertical texture.
