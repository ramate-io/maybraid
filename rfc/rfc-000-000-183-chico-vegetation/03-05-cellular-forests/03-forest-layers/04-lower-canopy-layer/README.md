...
The lower canopy layer selects from [Well-known Lower Canopy Groves](../../../03-04-cellular-groves/03-04-06-well-known-lower-canopy-groves/README.md). It covers subcanopy trees and tall intermediate growth that sit below the dominant upper canopy.
...
Selection uses [Bucket Throw](../../../03-04-cellular-groves/03-04-02-selection-and-placement/03-04-02-01-bucket-throw/README.md). If a lower canopy grove is selected, it is instantiated independently of the upper canopy, but the forest layering should ensure the two make ecological and visual sense together.
