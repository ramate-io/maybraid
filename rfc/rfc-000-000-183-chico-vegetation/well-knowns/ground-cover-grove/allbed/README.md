...
Allbed is a broad, mixed ground-cover grove combining flecking and non-flecking bump outs, colliding and non-colliding surface layers, and [Grassy Mounds](../grassy-mounds/README.md). It is the most general ground-cover bed and is useful when a region should feel lush, varied, and continuous without committing to a single ground-cover pattern.
