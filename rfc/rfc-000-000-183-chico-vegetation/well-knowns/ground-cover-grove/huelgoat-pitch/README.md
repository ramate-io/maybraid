...
Huelgoat Pitch is a low, smooth ground-cover grove based on shallow [bump outs](../../../README.md#331-bump-outs). It should read as mossy, soft, and continuous, closely following the underlying terrain with only slight vertical lift.
...
* Pair with sparse [Tufts](../../../README.md#332-tufts) for additional volume detail.
