...
This page is subsection **3.1.9** of [RFC-183: Chico Vegetation](../../README.md)
...
- [3.1.9.1: Species Palette](./01-species-palette/README.md)
- [3.1.9.2: World-space Variation](./02-world-space-variation/README.md)
- [3.1.9.3: WGSL Sketch](./03-wgsl-sketch/README.md)
- [3.1.9.4: Notes](./04-notes/README.md)
