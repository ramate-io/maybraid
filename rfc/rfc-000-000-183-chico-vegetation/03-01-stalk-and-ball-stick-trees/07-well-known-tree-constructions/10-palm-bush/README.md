...
Use the [Palm Crown](../../06-well-known-component-constructions/01-palm-crown/README.md#3161-palm-crown) construction with more layers to achieve density.
...
Use [Fronds](../../02-ball-components/07-fronds/README.md#3127-fronds) with moderate length and strong droop for lower layers.
...
Not applicable. Fronds are directly allocated from the crown anchor. Optionally, use a small central [Tuft](../../02-ball-components/06-tufts/README.md#3126-tufts) to conceal the origin point.
...
* Add [Fruiting Bodies](../../06-well-known-component-constructions/07-fruiting-bodies/README.md#3167-fruiting-bodies) near the base for decorative or exotic forms.
