...
Use a high-noise [Noisy Cylinder](../../01-stick-and-stalk-components/01-noisy-cylinder/README.md#3111-noisy-cylinder), optionally with [Crook Cylinder](../../01-stick-and-stalk-components/02-crook-cylinder/README.md#3112-crook-cylinder) variants for secondary trunks.
...
Then apply [Banyan Descenders](../../06-well-known-component-constructions/06-banyan-descenders/README.md#3166-banyan-descenders) every third to fourth segment.
...
Use [Noisy Ball](../../02-ball-components/02-noisy-ball/README.md#3122-noisy-ball) or [Plane Splay](../../02-ball-components/05-plane-splay/README.md#3125-plane-splay) depending on detail level. For jungle variants, combine with [Jungle Growths](../../06-well-known-component-constructions/04-jungle-growths/README.md#3164-jungle-growths).
