...
Use the same stalk construction as [Storybook Tree](../01-storybook-tree/README.md#3171-storybook-tree), optionally shortened slightly for bush or ornamental variants.
...
Use a [Noisy Cylinder](../../01-stick-and-stalk-components/01-noisy-cylinder/README.md#3111-noisy-cylinder) or [Crook Cylinder](../../01-stick-and-stalk-components/02-crook-cylinder/README.md#3112-crook-cylinder) depending on desired stylization.
...
Use [Plane Splay](../../02-ball-components/05-plane-splay/README.md#3125-plane-splay) at high detail and [Noisy Ball](../../02-ball-components/02-noisy-ball/README.md#3122-noisy-ball) or icospheres at lower detail.
...
* Optional [Fruiting Bodies](../../06-well-known-component-constructions/07-fruiting-bodies/README.md#3167-fruiting-bodies) for orchard-like variants
