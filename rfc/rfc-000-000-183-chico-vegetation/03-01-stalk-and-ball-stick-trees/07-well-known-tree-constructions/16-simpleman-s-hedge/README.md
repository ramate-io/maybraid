...
Simpleman's Hedge is a minimal hedge construction that does not require ball-stick chains. It is built by placing [Plane Splay](../../02-ball-components/05-plane-splay/README.md#3125-plane-splay) components directly along the ground or along a hedge guide path.
...
* Add sparse [Fruiting Bodies](../../06-well-known-component-constructions/07-fruiting-bodies/README.md#3167-fruiting-bodies) for berry hedges.
