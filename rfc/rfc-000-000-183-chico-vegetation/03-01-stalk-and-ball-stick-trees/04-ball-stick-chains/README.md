...
Each segment becomes a stick component, usually a [noisy cylinder](../01-stick-and-stalk-components/01-noisy-cylinder/README.md#3111-noisy-cylinder) or [crook cylinder](../01-stick-and-stalk-components/02-crook-cylinder/README.md#3112-crook-cylinder). Each node becomes a possible site for foliage, descenders, joint-concealing balls, or additional child chains.
