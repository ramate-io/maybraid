...
Sope's Banyan is a banyan variant with a tall, vase-like crown. It begins from the [Honu Banyan](../03-01-07-05-honu-banyan/README.md#3175-honu-banyan) construction, but moves the canopy lower and biases branch growth upward, closer to the [Penmarch Torch](../03-01-07-04-penmarch-torch/README.md#3174-penmarch-torch). The result is a mystical, vertically rising banyan form suited to jungle, riparian, and elder-tree contexts.
...
Use high-noise bark and strong trunk mass, as in [Honu Banyan](../03-01-07-05-honu-banyan/README.md#3175-honu-banyan).
...
Bias rises with height, as in [Penmarch Torch](../03-01-07-04-penmarch-torch/README.md#3174-penmarch-torch):
...
Use [Noisy Ball](../../03-01-02-ball-components/03-01-02-02-noisy-ball/README.md#3122-noisy-ball), [Plane Splay](../../03-01-02-ball-components/03-01-02-05-plane-splay/README.md#3125-plane-splay), and optional [Jungle Growths](../../03-01-06-well-known-component-constructions/03-01-06-04-jungle-growths/README.md#3164-jungle-growths) for dense variants.
...
* Add [Fruiting Bodies](../../03-01-06-well-known-component-constructions/03-01-06-07-fruiting-bodies/README.md#3167-fruiting-bodies) for mystical or ancient variants.
* Use [Crook Cylinder](../../03-01-01-stick-and-stalk-components/03-01-01-02-crook-cylinder/README.md#3112-crook-cylinder) on major limbs for a more twisted appearance.
