...
Use a [Noisy Cylinder](../../03-01-01-stick-and-stalk-components/03-01-01-01-noisy-cylinder/README.md#3111-noisy-cylinder) for the stalk. Noise should be visible but not dominant.
...
At high detail, allocate [Plane Splay](../../03-01-02-ball-components/03-01-02-05-plane-splay/README.md#3125-plane-splay) primarily on the outer canopy:
...
* Optional [Fruiting Bodies](../../03-01-06-well-known-component-constructions/03-01-06-07-fruiting-bodies/README.md#3167-fruiting-bodies) for orchard or magical variants
...
* Higher angular variance and [Crook Cylinder](../../03-01-01-stick-and-stalk-components/03-01-01-02-crook-cylinder/README.md#3112-crook-cylinder) segments produce older or more whimsical silhouettes.
