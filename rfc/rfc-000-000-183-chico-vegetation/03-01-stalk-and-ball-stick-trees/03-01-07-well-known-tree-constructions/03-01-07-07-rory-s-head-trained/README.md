...
Use a standard [Noisy Cylinder](../../03-01-01-stick-and-stalk-components/03-01-01-01-noisy-cylinder/README.md#3111-noisy-cylinder).
...
Use moderate projection lengths similar to [Storybook Tree](../03-01-07-01-storybook-tree/README.md#3171-storybook-tree), but keep the canopy flatter.
...
Use compact [Plane Splay](../../03-01-02-ball-components/03-01-02-05-plane-splay/README.md#3125-plane-splay), [Noisy Ball](../../03-01-02-ball-components/03-01-02-02-noisy-ball/README.md#3122-noisy-ball), or [Tufts](../../03-01-02-ball-components/03-01-02-06-tufts/README.md#3126-tufts) depending on species.
...
* Optional [Fruiting Bodies](../../03-01-06-well-known-component-constructions/03-01-06-07-fruiting-bodies/README.md#3167-fruiting-bodies) for orchard or grape-like variants
