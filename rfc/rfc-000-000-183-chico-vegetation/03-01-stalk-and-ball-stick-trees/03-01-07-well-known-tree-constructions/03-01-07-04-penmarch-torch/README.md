...
The Penmarch Torch is an upward-projecting variant of the [Vase Tree](../03-01-07-03-vase-tree/README.md#3173-vase-tree). Instead of relaxing toward horizontal near the top, its branches become increasingly vertical, producing a flame-like or torch-like silhouette.
...
Use the [Vase Tree](../03-01-07-03-vase-tree/README.md#3173-vase-tree) stalk, usually slightly shorter and more compact.
...
A [Crook Cylinder](../../03-01-01-stick-and-stalk-components/03-01-01-02-crook-cylinder/README.md#3112-crook-cylinder) may be used for stylized urban or chaparral variants.
...
Use the same upper-widening profile as the [Vase Tree](../03-01-07-03-vase-tree/README.md#3173-vase-tree), but generally with a smaller maximum spread:
...
Use compact [Plane Splay](../../03-01-02-ball-components/03-01-02-05-plane-splay/README.md#3125-plane-splay), [Tufts](../../03-01-02-ball-components/03-01-02-06-tufts/README.md#3126-tufts), or [Noisy Ball](../../03-01-02-ball-components/03-01-02-02-noisy-ball/README.md#3122-noisy-ball) depending on desired density.
