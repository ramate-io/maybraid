...
The Braid Oak is a gnarled, expressive broadleaf tree with interweaving branch structure. It builds on the [Storybook Tree](../03-01-07-01-storybook-tree/README.md#3171-storybook-tree) but introduces strong directional variation and curvature, producing a braided, organic canopy with rich silhouette complexity.
...
Prefer [Crook Cylinder](../../03-01-01-stick-and-stalk-components/03-01-01-02-crook-cylinder/README.md#3112-crook-cylinder) for the stalk to introduce subtle curvature and age.
...
Use [Crook Cylinder](../../03-01-01-stick-and-stalk-components/03-01-01-02-crook-cylinder/README.md#3112-crook-cylinder) for all segments:
...
* [Plane Splay](../../03-01-02-ball-components/03-01-02-05-plane-splay/README.md#3125-plane-splay) for outer canopy
* [Noisy Ball](../../03-01-02-ball-components/03-01-02-02-noisy-ball/README.md#3122-noisy-ball) for interior mass
...
* Add [Jungle Growths](../../03-01-06-well-known-component-constructions/03-01-06-04-jungle-growths/README.md#3164-jungle-growths) for overgrown variants
* Add [Fruiting Bodies](../../03-01-06-well-known-component-constructions/03-01-06-07-fruiting-bodies/README.md#3167-fruiting-bodies) for acorns or stylized fruit
