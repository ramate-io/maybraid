...
This page is subsection **3.1.7.10** of [RFC-183: Chico Vegetation](../../../README.md)
...
Use the [Palm Crown](../../03-01-06-well-known-component-constructions/03-01-06-01-palm-crown/README.md#3161-palm-crown) construction with more layers to achieve density.
...
Use [Fronds](../../03-01-02-ball-components/03-01-02-07-fronds/README.md#3127-fronds) with moderate length and strong droop for lower layers.
...
Not applicable. Fronds are directly allocated from the crown anchor. Optionally, use a small central [Tuft](../../03-01-02-ball-components/03-01-02-06-tufts/README.md#3126-tufts) to conceal the origin point.
...
* Add [Fruiting Bodies](../../03-01-06-well-known-component-constructions/03-01-06-07-fruiting-bodies/README.md#3167-fruiting-bodies) near the base for decorative or exotic forms.
