...
Use the [Palm Trunk](../../03-01-06-well-known-component-constructions/03-01-06-02-palm-trunk/README.md#3162-palm-trunk) construction with a gentle arch.
...
Use the [Palm Crown](../../03-01-06-well-known-component-constructions/03-01-06-01-palm-crown/README.md#3161-palm-crown) construction.
...
Use [Fronds](../../03-01-02-ball-components/03-01-02-07-fronds/README.md#3127-fronds) as mesh-based arching chains.
...
Waialea Palm does not use ordinary ball selection over a branch graph. The crown directly allocates fronds from crown anchors. Optional small [Tufts](../../03-01-02-ball-components/03-01-02-06-tufts/README.md#3126-tufts) may be placed at the crown center to conceal the frond origins.
...
* Add [Fruiting Bodies](../../03-01-06-well-known-component-constructions/03-01-06-07-fruiting-bodies/README.md#3167-fruiting-bodies) near the crown for coconut-like variants.
