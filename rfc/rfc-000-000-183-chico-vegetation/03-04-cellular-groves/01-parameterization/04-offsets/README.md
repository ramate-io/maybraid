...
As discussed in [Cell Selection and Planting Constraints](../../02-selection-and-placement/README.md#342-selection-and-placement), this follows the same approach as
