...
Floor Scrub is a low-density variant of [Jim's Collage](../03-jim-s-collage/README.md#3433-jims-collage). It uses the same basic split between [Huelgoat Pitch](../01-huelgoat-pitch/README.md#3431-huelgoat-pitch) and [Flecking Bed](../02-flecking-bed/README.md#3432-flecking-bed), but reduces coverage and uses smaller internal cells for a patchier, more exposed ground layer.
