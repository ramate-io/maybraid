...
Huelgoat Pitch is a low, smooth ground-cover grove based on shallow [bump outs](../../../03-03-ground-cover/01-bump-outs/README.md). It should read as mossy, soft, and continuous, closely following the underlying terrain with only slight vertical lift.
