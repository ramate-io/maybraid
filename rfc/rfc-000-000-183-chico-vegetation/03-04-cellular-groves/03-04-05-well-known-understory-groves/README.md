...
- [3.4.5.1: Braid Grass](./03-04-05-01-braid-grass/README.md): dense `1m–3m` braided grass masses for humid valleys, jungle margins, and overgrown transitions.
- [3.4.5.2: Monster Grass](./03-04-05-02-monster-grass/README.md): oversized `2m–5m` grass walls for giant jungle, swamp, elder-tree, or fantasy understory.
