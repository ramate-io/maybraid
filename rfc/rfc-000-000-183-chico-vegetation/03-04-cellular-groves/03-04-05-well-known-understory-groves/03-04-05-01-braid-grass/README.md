...
Braid Grass is the understory equivalent of [Tall Grass](../../03-04-04-well-known-tufts-groves/03-04-04-02-tall-grass/README.md). It represents dense, human-height grass masses in the `1m-3m` range, where individual clumps are tall enough to read as understory vegetation rather than ground or tuft detail.
...
* Use blade clusters around `1m–3m`; shorter forms should usually remain [Tall Grass](../../03-04-04-well-known-tufts-groves/03-04-04-02-tall-grass/README.md).
...
* Pair with sparse [Tropical Tufts](../../03-04-04-well-known-tufts-groves/03-04-04-05-tropical-tufts/README.md), reeds, wet soil, jungle trees, or riparian forest edges.
