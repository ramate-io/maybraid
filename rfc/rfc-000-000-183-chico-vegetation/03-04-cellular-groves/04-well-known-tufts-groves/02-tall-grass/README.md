...
Tall Grass is a dense tuft grove made from the [Tuft](../../../03-01-stalk-and-ball-stick-trees/02-ball-components/06-tufts/README.md) construction. It represents grass clumps in the `50cm–100cm` range, reserving taller forms for understory systems.
...
* Pair well with [Flecking Bed](../../03-well-known-ground-cover-groves/02-flecking-bed/README.md) and [Allbed](../../03-well-known-ground-cover-groves/06-allbed/README.md).
