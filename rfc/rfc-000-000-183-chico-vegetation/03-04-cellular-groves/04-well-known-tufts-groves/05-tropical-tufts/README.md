...
Tropical Tufts is a sparse tropical ground grove using [Tuft](../../../03-01-stalk-and-ball-stick-trees/02-ball-components/06-tufts/README.md) and small [Palm Bush](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/10-palm-bush/) constructions.
