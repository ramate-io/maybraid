...
* Select among a few varietals using [Bucket Throw](../../02-selection-and-placement/01-bucket-throw/README.md).
...
* Overlay on [Huelgoat Pitch](../../03-well-known-ground-cover-groves/01-huelgoat-pitch/README.md), [Flecking Bed](../../03-well-known-ground-cover-groves/02-flecking-bed/README.md), or [Allbed](../../03-well-known-ground-cover-groves/06-allbed/README.md).
