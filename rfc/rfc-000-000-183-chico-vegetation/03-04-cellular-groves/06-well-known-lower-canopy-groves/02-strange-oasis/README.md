...
Strange Oasis is a low-density lower-canopy grove built around compact [Date Palm](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/09-date-palm/README.md), rare [Penmarch Torch](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/04-penmarch-torch/README.md), and less common [Storybook Tree](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/01-storybook-tree/README.md) variants.
