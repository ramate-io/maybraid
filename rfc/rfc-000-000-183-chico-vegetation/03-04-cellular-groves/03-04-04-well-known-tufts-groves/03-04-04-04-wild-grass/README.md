...
Wild Grass is a dense, colorful tuft grove using the [Tuft](../../../03-01-stalk-and-ball-stick-trees/03-01-02-ball-components/03-01-02-06-tufts/README.md) construction. It represents tall grass in the `50cm–100cm` range with many varietals and strong color variation.
...
* Select among many varietals using [Bucket Throw](../../03-04-02-selection-and-placement/03-04-02-01-bucket-throw/README.md).
* Allow stronger palette variation than [Tall Grass](../03-04-04-02-tall-grass/README.md).
...
* Pair with [Flecking Bed](../../03-04-03-well-known-ground-cover-groves/03-04-03-02-flecking-bed/README.md) for flowering meadow effects.
* Pair with [Grassy Mounds](../../03-04-03-well-known-ground-cover-groves/03-04-03-05-grassy-mounds/README.md) for rolling grassland texture.
