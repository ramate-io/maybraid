...
pub enum UnendingJungleCell {
    MiniHonuBanyan(Bucket {
        ...
        item: HonuBanyan {
            ...
            palette_mix: [[deep_green..wet_green], [blue_green..emerald_green]],
        },
    }),
    MiniSopeBanyan(Bucket {
        weight: 1.0,
        placement_constraints: PlacementConstraints {
            elevation: 0.0..0.52,
            steepness: 0.0..0.48,
        ...
        item: SopesBanyan {
            ...
            canopy_density: Moderate,
            descender_frequency: Sparse,
            palette_mix: [[dark_green..deep_green], [wet_green..fresh_green]],
        },
    }),
    JungleStorybook(Bucket {
        weight: 2.0,
        placement_constraints: PlacementConstraints {
            elevation: 0.0..0.58,
            steepness: 0.0..0.64,
        ...
        item: StorybookTree {
            height: 3.0..5.0,
            canopy_density: Moderate,
            palette_mix: [[lush_green..bright_green], [deep_green..fresh_green]],
        },
    }),
    PenmarchAccent(Bucket {
        ...
        item: PenmarchTorch {
            ...
            palette_mix: [[wet_green..lime_green], [dark_green..fresh_green]],
        },
    }),
    RoryAccent(Bucket {
        weight: 0.35,
        ...
        item: RoryHeadTrained {
            ...
            palette_mix: [[blue_green..deep_green], [yellow_green..fresh_green]],
        },
    }),
    WaialeaPalmAccent(Bucket {
        ...
        item: WaialeaPalm {
            ...
            palette_mix: [[lush_green..bright_green], [wet_green..lime_green]],
        },
    }),
}
