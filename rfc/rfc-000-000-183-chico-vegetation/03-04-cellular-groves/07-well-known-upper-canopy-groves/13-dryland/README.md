...
Dryland is a very-low-density upper-canopy grove for arid highlands and sparse dry forests. It uses common [Liam's Conifer](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/02-liam-s-conifer/README.md) and [Vase Tree](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/03-vase-tree/README.md) variants at `10m-20m`.
