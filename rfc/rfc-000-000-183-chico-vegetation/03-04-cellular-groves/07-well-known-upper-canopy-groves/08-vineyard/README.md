...
Vineyard is a moderate-density cultivated grove with low cell offset. It uses low [Rory's Head-trained](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/07-rory-s-head-trained/README.md) variants at `1.5m-3m`, turning the trained crown logic into rows of vine-like shrubs.
