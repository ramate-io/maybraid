...
Rolling Oaks is a low-density upper-canopy grove for open oak country. It uses common [Braid Oak](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/13-braid-oak/README.md) variants at `5m-20m` and rare [Storybook Tree](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/01-storybook-tree/README.md) variants at the same scale.
