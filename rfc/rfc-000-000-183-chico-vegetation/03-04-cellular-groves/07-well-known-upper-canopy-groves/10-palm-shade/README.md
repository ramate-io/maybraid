...
Palm Shade is a low-density upper-canopy grove using common [Waialea Palm](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/08-waialea-palm/README.md) variants at `8m-40m` and common [Date Palm](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/09-date-palm/README.md) variants at `6m-20m`.
