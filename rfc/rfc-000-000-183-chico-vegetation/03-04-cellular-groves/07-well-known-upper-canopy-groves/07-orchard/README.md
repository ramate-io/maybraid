...
Orchard is a moderate-density upper-canopy grove with low cell offset. It uses compact [Storybook Tree](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/01-storybook-tree/README.md) variants at `5m-10m` and includes fruiting texture variants.
