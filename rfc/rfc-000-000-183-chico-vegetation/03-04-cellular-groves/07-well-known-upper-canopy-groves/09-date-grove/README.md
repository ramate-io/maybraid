...
Date Grove is a moderate-density cultivated upper-canopy grove similar to [Orchard](../07-orchard/README.md), but using [Date Palm](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/09-date-palm/README.md) variants with date fruiting textures.
