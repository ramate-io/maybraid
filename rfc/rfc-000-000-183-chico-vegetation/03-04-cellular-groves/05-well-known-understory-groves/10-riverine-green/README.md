...
Riverine Green is a sparse understory grove made from green [High Bush](../04-high-bush/README.md) and [Common High Bush](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/12-common-high-bush/README.md) variants.
...
* Pair with damp ground cover, reeds, [Braid Grass](../01-braid-grass/README.md), exposed mud, stones, and riparian tree layers.
