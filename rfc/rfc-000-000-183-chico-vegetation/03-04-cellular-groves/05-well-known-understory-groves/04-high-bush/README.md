...
High Bush is a moderate-density understory grove using the [Common High Bush](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/12-common-high-bush/README.md) construction scaled into the `1m–2.5m` range. It represents substantial shrub masses that sit between low bushes and small trees.

It should feel leafy, rounded, and body-height: bushes are tall enough to shape sightlines and local movement, but not tall enough to read as canopy vegetation. Compared to [Low Bush](../03-low-bush/README.md), High Bush uses stronger branching, larger silhouettes, and more visible foliage mass.
...
* Pair with [Low Bush](../03-low-bush/README.md), Braid Grass, forest-floor ground cover, fallen logs, and tree bases.
