...
Tropical Thicket is a dense tropical understory grove using larger [Palm Bush](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/10-palm-bush/README.md), mini [Honu Banyan](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/05-honu-banyan/README.md), and moderate-size [Common High Bush](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/12-common-high-bush/README.md) constructions.

It represents a thicker, woodier tropical mid-layer than [Tropical Undergrowth](../05-tropical-undergrowth/README.md): broad palm leaves provide the main mass, small banyan-like forms add irregular trunk and descender structure, and common high bushes fill the gaps with rounded shrub volume.
...
* Pair with [Tropical Undergrowth](../05-tropical-undergrowth/README.md), [Monster Grass](../02-monster-grass/README.md), wet ground cover, vines, roots, and larger jungle trees.
