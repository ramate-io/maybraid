...
Monster Grass is an extreme understory grass grove derived from [Tall Grass](../../04-well-known-tufts-groves/02-tall-grass/README.md) and [Braid Grass](../01-braid-grass/README.md). It represents oversized grass masses in the `2m–5m` range, where blades are tall enough to read as environmental structure rather than simple vegetation.
...
* Use giant blade clusters around `2m–5m`; shorter forms should usually remain [Braid Grass](../01-braid-grass/README.md).
...
* Pair with swamp ground cover, [Tropical Tufts](../../04-well-known-tufts-groves/05-tropical-tufts/README.md), dense canopy, vines, exposed roots, or elder-tree vegetation.
