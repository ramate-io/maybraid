...
Levantine Scrub is a dry Mediterranean understory grove using [Rory's Head-trained](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/07-rory-s-head-trained/README.md), small [Vase Tree](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/03-vase-tree/README.md), [High Bush](../04-high-bush/README.md), small [Penmarch Torch](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/04-penmarch-torch/README.md), and [Simpleman's Hedge](../../../03-01-stalk-and-ball-stick-trees/07-well-known-tree-constructions/16-simpleman-s-hedge/README.md) constructions.
