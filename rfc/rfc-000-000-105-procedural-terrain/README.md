...
- [2: Prior Art](#2-prior-art)
    - [2.1: Theory](#21-theory)
        ...
        - [2.1.3: Implicit surfaces, marching cubes, and CSG](#213-implicit-surfaces-marching-cubes-and-csg)
        - [2.1.4: Hydraulic and thermal erosion](#214-hydraulic-and-thermal-erosion)
        - [2.1.5: River networks and stream order](#215-river-networks-and-stream-order)
        - [2.1.6: Scatter placement (Poisson disk, Worley / cellular noise)](#216-scatter-placement-poisson-disk-worley--cellular-noise)
    ...
    - [2.3: Exploratory code (non-normative)](#23-exploratory-code-non-normative)
- [3: Design](#3-design)
